import svgPaths from "./svg-d1mafzam2v";
...
function Container17() {
  return (
    <div className="bg-[#e7000b] h-[31px] opacity-56 relative shrink-0 w-[932.333px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon6 />
  ...
  return (
    <div className="flex-[1_0_0] h-[393.938px] min-h-px min-w-px relative" data-name="Container">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pl-[32px] pr-[52px] pt-[-221.333px] relative size-full">
          <Container26 />
        </div>
      </div>
    </div>
...
function Button7() {
  return (
    <div className="absolute bg-[#006045] h-[33.667px] left-[7.67px] top-[349.31px] w-[175.125px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[1.333px] border-black border-solid inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Tinos:Bold',sans-serif] leading-[15px] left-[87.65px] not-italic text-[10px] text-center text-white top-[8.67px] uppercase">PLATAFORMA GESTIÓN</p>
      </div>
      <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_1px_1px_0px_0px_rgba(255,255,255,0.2)]" />
    </div>
  );
}
