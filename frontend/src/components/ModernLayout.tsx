...
import { Shield, Lock, Bell, Search, User, LogOut, ChevronRight, CheckCircle, AlertCircle } from 'lucide-react';
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-6 shrink-0 z-10 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold tracking-tight text-slate-900">SIDPOL <span className="text-blue-600 font-black">2.0</span></h1>
              <p className="text-[10px] text-slate-500 font-medium uppercase tracking-wider -mt-1">Sistema Integrado de Gestión Policial</p>
            </div>
            {title && (
              <>
            ...
            {user ? (
              <div className="flex items-center gap-3">
                <div className="text-right hidden sm:block">
                  ...
                  <p className="text-[10px] text-slate-500 font-medium">{user.rank} • {user.badge}</p>
                </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-bold text-green-600 uppercase tracking-widest">Conexión Encriptada AES-256</span>
              </div>
            )}
          </div>
        </header>
